...
var camera, cameraTarget, scene, renderer, original_geo, loader2;
    ...
    loader.load('./data/moved_1.ply', function ( geometry) {
        ...
        points.forEach(function(element){
            ...
            if(x >= rec_left && x <= rec_right && y >= rec_bottom && y <= rec_top){
                ...
                geometry.attributes.color.array[index-2] = 1;
            }
            i++;
...
function showSurfaceArea(mouse, pointIndices){
    var surfaceArea = 0;
    var plyFn = document.getElementById("returnBox").value;
    calcSurfaceArea(pointIndices, plyFn)
    //var surfaceArea = document.getElementById("surfaceAreaBox").value; //TODO: need to refresh now. Any better way to get the value?
...
function calcSurfaceArea(selectedPointIdLis, plyFileName) {
    ...
    loader2.load(plyFileName, function (geometry) {
        geometry.computeVertexNormals();
        ...
        // document.getElementById("surfaceAreaBox").value = surfaceArea; //TODO: any better way to get the returned value?
    });
